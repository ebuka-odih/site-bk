            ...
            <div class="col-xl-5">
                <div class="mil-banner-text">
                    ...
                    <div class="mil-buttons-frame">
                        <a href="register.html" class="mil-btn mil-md mil-add-arrow">Open an Account</a>
                        <a href="contact.html" class="mil-btn mil-md mil-transp mil-add-play">Talk to a Banker</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-7">
        ...
        <div class="mil-out-frame mil-out-top mil-visible">
            <div class="row flex-sm-row-reverse justify-content-between align-items-center">
                <div class="col-xl-5 mil-mb-60">
                    ...
                    <div class="mil-up"><a href="services.html" class="mil-btn mil-m mil-add-arrow">Explore Services</a></div>
                </div>
                <div class="col-xl-6">
...
<div class="mil-dark-2 mil-p-160-130">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 mil-mb-30">
                <div class="mil-icon-box mil-with-bg mil-dark-2 mil-center mil-up">
                    ...
                    <img src="img/home-5/icons/1.svg" alt="Personal details icon" class="mil-mb-30 mil-up">
            ...
            <div class="col-xl-4 mil-mb-30">
                <div class="mil-icon-box mil-with-bg mil-dark-2 mil-center mil-up">
                    ...
                    <img src="img/home-5/icons/2.svg" alt="KYC verification icon" class="mil-mb-30 mil-up">
            ...
            <div class="col-xl-4 mil-mb-30">
                <div class="mil-icon-box mil-with-bg mil-dark-2 mil-center mil-up">
                    ...
                    <img src="img/home-5/icons/3.svg" alt="Savings icon" class="mil-mb-30 mil-up">
        ...
        <div class="mil-text-center mil-up">
            <a href="register.html" class="mil-btn mil-m mil-add-arrow">Open Account</a>
        </div>
    </div>
</div>
<!-- account steps end -->
        ...
        <div class="mil-out-frame mil-bg-2">
            <div class="row justify-content-center align-items-center mil-p-160-160">
                <div class="col-xl-7 mil-text-center">
                    ...
                    <div class="mil-up"><a href="register.html" class="mil-btn mil-md mil-add-arrow">Get Started</a></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row flex-sm-row-reverse justify-content-between align-items-center">
            <div class="col-xl-6 mil-mb-80">
                ...
                <div class="mil-up"><a href="career-details.html" class="mil-btn mil-m mil-add-arrow">Meet Our Specialists</a></div>
            </div>
            <div class="col-xl-5 mil-mb-80">
                <div class="mil-image-frame mil-up">
    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-xl-6 mil-mb-60">
                ...
                <div class="mil-up"><a href="services.html" class="mil-btn mil-m mil-add-arrow">View All Solutions</a></div>
            </div>
            <div class="col-xl-6">
        ...
        <div class="row">
            <div class="col-xl-3">
                <a href="#." class="mil-footer-logo mil-mb-60">
                    <img src="img/logo-2.png" alt="Banko" width="28" height="32">
                </a>
            </div>
